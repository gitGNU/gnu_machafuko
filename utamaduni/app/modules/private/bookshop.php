...
class bookshop extends core_auth_user
{
   ...
   *
   * This function will delete a bookshop.
   *
   * @author Román Ginés Martínez Ferrández <rgmf@riseup.net>
   */
  public function delete ()
  {
    ...
    $tpl_bookshop = file_get_contents (UT_HTML_TPL_PATH . '/bookshopform.html');
    $this -> set ('bookshop', $tpl_bookshop);
	...
	try
	  {
	    ...
	    $href = "javascript: bookshoploader.loadXMLContent ();";
    ...
    $this -> set ('bookshop', file_get_contents (dirname (__FILE__) . '/tpl/msg.tpl.html'));
  ...
  public function show ()
  {
	...
	$this -> set ('delete_bookshop_msg', gettext ('Delete bookshop'));
