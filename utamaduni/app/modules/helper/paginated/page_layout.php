 ...
 * page_layout.php
 *
 * The interface which specifies the behaviour all page layout classes
 * must implement page_layout is a part of paginated and can reference
 * programmer defined layouts.
 *
 * @author Román Ginés Martínez Ferrández <rgmf@riseup.net>
 * @copyright Román Ginés Martínez Ferrández <rgmf@riseup.net>
 * @license http://www.gnu.org/licenses/gpl.html
 */
interface page_layout
{
