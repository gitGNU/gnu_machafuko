 ...
 * whoami.php
 *
 * This module show the user information when is log in.
 *
 * @author Román Ginés Martínez Ferrández <rgmf@riseup.net>
 * @copyright Román Ginés Martínez Ferrández <rgmf@riseup.net>
 * @license http://www.gnu.org/licenses/gpl.html
 */
class whoami extends core_auth_user
{
  // {{{ __construct ()
  /**
   * __construct
  ...
  {
    $this -> set ('last_name', $this -> session -> lname);
    $this -> set ('name', $this -> session -> fname);
  }
  // }}}
}
