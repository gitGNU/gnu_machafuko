...
/**
 * html_element_submit.php
 *
 * Submit form. Is a special button.
 *
 * @author Román Ginés Martínez Ferrández <rgmf@riseup.net>
 * @copyright Román Ginés Martínez Ferrández <rgmf@riseup.net>
 * @license http://www.gnu.org/licenses/gpl.html
 */
class html_element_submit extends html_element_button
{
  // {{{ __construct ()
  /**
   * __construct
  ...
  public function __construct ($id, $class = null, $name = null)
  {
    ...
    $this -> value = "submit"; // Submit button default value.
  }
  // }}}
  ...
  public function to_html ()
  {
    ...
    $html .= "<input type='submit' id='" . $this -> id . "' name='" .
