 ...
 * core_object_web
 *
 * This is the base class for web applications extended from core_module,
 ...
 */
abstract class core_object_web extends core_object
{
  // {{{ properties
  /**
   * $user
   ...
   *
   * @author Román Ginés Martínez Ferrández <rgmf@riseup.net>
   * @var mixed $user Instance of core_user of current user.
   */
  protected $user;
   ...
   *
   * @author Román Ginés Martínez Ferrández <rgmf@riseup.net>
   * @var mixed $session Instance of core_session.
   */
  protected $session;
  // }}}
